...
const Show = ({ size, fill }) => {
    return (
        ...
        >
            <title>Iconly/Bulk/Show</title>
            <g id="Iconly/Bulk/Show" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                <g
                    id="Show"
