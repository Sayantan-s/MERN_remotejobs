...
const CheckBoxGroup = () => {
    ...
    return (
        <svg id="visual" viewBox="0 0 24 24" width={36} height={36} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1">
            ...
            <path d="M8.4 -4.8C9.8 -2.3 9.2 1.3 7.5 4.1C5.8 6.8 2.9 8.7 0 8.7C-2.9 8.7 -5.8 6.8 -7.2 4.3C-8.7 1.7 -8.7 -1.7 -7.2 -4.2C-5.8 -6.7 -2.9 -8.3 0.3 -8.5C3.5 -8.7 6.9 -7.3 8.4 -4.8" fill={1 ? theme.colors.blue[4] : 'none'} stroke={theme.colors.blue[4]} strokeWidth={2} />
            </g>
        </svg>
    )
}
