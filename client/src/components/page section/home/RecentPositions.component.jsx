...
const RecentPositions = () => {
    ...
    useEffect(() => {
        (async () => {
            const { data } = await http.get('/jobs?limit=4&home=true');
            setJobs(data.data);
        })();
    }, []);
            ...
            <View maxWidth="desktop" m="0 auto">
                <Flex alignItems="center" justifyContent="space-between">
                    <Flex flexDirection="column">
                        ...
                        <Text mt="2">We think these jobs might be of your interest.</Text>
                    </Flex>
                    <Link to="/jobs">
                ...
                <StackVertical mt={12} gap={7}>
                    {jobs?.map(({ companyInfo, roleInfo, ...data }) => (
                        <HomeJobCards key={data._id} {...companyInfo} {...roleInfo} {...data} />
                    ))}
                </StackVertical>
            </View>
        </View>
