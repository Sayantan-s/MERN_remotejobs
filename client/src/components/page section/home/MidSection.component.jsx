    ...
    return (
        <View maxWidth="desktop" m="0 auto" py={13}>
            <Flex justifyContent="center" alignItems="center">
                <View>
                    <View>
                        <Heading level={3}>Hire the best people</Heading>
                ...
                <View ml={9}>
                    <Image.Picture
                        src={
                            'https://images.unsplash.com/photo-1623122245120-7eef6faa39c6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80'
                        }
                        size={'l'}
                        alt="photo_office"
                    />
