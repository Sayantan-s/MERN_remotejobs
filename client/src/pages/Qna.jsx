...
const Qna = () => {
    ...
    const timer = useTimer({ minutes: 3 });
    ...
    return (
        <Page maxWidth="100%">
            <Flex
                ...
                m="0 auto"
            >
                <Link to="/" position="absolute" top="4" left="0">
                    <Logo />
                </Link>
                <Flex alignItems="baseline">
                    <Text fontSize="semil" color="text.1">
                        0{qid + 1}
                    </Text>
                    <View ml="6">
                        <View>
                ...
                >
                    ...
                    <Text as="span" fontSize="m" fontWeight="regular" color="blue.4">
                        &nbsp;:&nbsp;
                        {timer % 60 === 0
                            ? '0' + 0
                            : timer % 60 < 10
                ...
                <Flex ml="6" mt={6} position="absolute" bottom="6" right="0">
